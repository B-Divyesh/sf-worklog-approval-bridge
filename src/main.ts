...
function downloadPage() {
  ...
  return `${header("download")}<main id="main" class="download-page"><div class="narrow"><p class="eyebrow">Desktop app · v0.1.0</p><h1 tabindex="-1">Install Worklog Bridge</h1><p class="lede">Choose the app for your computer. Your worklogs remain local after installation.</p><div class="download-box" id="download-box" aria-live="polite"><p class="platform-label">Checking your platform and the latest release…</p></div><h2>Command line install</h2><p>Each installer checks the downloaded file against the published SHA-256 checksum.</p><p>macOS and Linux</p><div class="code-line">curl -fsSL ${SITE}/install.sh | sh</div><p>Windows PowerShell</p><div class="code-line">irm ${SITE}/install.ps1 | iex</div><div class="notice"><strong>Unsigned preview:</strong> The first release is unsigned. Your operating system may ask you to confirm that you trust it.</div></div></main>${footer()}`;
}
