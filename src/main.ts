...
function footer() {
  return `<footer class="site-footer"><div class="shell footer-grid">
      <div><p>Worklog Bridge turns selected Git and calendar activity into a client-ready worklog.</p><p class="build-id">Unsigned desktop packages · v${__WORKLOG_VERSION__} · Generated hero art disclosed in the design record.</p></div>
